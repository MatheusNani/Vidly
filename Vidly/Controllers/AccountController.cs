		...
		public async Task<ActionResult> Register(RegisterViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					// Temp Code
					/*
						Insert the code below, then register a new User for instance (Admin)
						then, comment the code below, and Add a new Migration.
						In the new Migration(it should be empty), insert the INSERT script from, AspNetUsers,AspNetRoles 
